...
import {ImgHeding,Hesading1 ,Paragraph2,Icon1} from '../styled/Container.js'
const Reset = ({handleSubmit}) => {
  return (
    <div> 
      ...
      <Paragraph2>Your Password has been Successfully Reset.
Click Below To Login</Paragraph2>
